...
- 15及以上的Mac版本，在开启SIP时会反复跳出`"Get Oudio"想访问其他App的数据。`的提示窗口，以至于难以正常使用。
  > 这是由于我没有支付Apple开发者99刀的年费，因而Mac无法验证App Group目录的所属，所以请关闭SIP使用该软件。（如果你使用UAD的驱动，或使用过许多学习版软件，SIP通常已处于关闭状态。）

## 功能

- 靠右键和双击重新编码音频文件，包含音频行业惯用的所有制式。
- 靠右键提取视频文件的音频轨，保留原始编码。
- 靠右键和双击剥离`.ncm`文件的加密。
- 靠右键分享从Apple Music下载无损音源。
- 靠小组件回录系统音频，自动剥离无声并标准化。（目前依赖Protools AudioBridge）
...
https://github.com/user-attachments/assets/76467424-9f24-431f-8d07-c2409525a779

https://github.com/user-attachments/assets/4c4d2fb1-a253-4d7f-9c66-d6f0349ab373

https://github.com/user-attachments/assets/0d378436-9c3d-46da-bc4b-f86bb281a2c9

https://github.com/user-attachments/assets/e9335076-ce8e-46fd-9b43-4596bb17e950
